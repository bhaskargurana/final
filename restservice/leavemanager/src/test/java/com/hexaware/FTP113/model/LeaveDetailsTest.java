...
/**
  ...
  */
  ...
  public final void testApplyLeave(@Mocked final EmployeeDAO edao, @Mocked final LeaveDetailsDAO ldao)
    ...
    String res9 = LeaveDetails.applyLeave(19, "2019-04-28", "2019-04-30", 1, LeaveType.EL, "Sick");
    assertEquals(res9, "StartDate cannot be sunday...");
    String res10 = LeaveDetails.applyLeave(19, "2019-04-27", "2019-04-29", 1, LeaveType.EL, "Sick");
    assertEquals(res10, "StartDate cannot be saturday...");
    String res11 = LeaveDetails.applyLeave(19, "2019-08-15", "2019-08-17", 1, LeaveType.EL, "Sick");
    assertEquals(res11, "StartDate cannot be Independence Day");
  }
    /**
  * @param edao for mocking EmployeeDAO class.
  * @param ldao for mocking LeaveDetailsDAO class.
